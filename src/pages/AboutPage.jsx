...
export default function AboutPage() {
  ...
  const education = [
    ...
    },
    {
      ...
      year: "2024",
      description: "Passed a proctored exam on HTML and CSS at a Certiport Authorized Testing Center.",
    },
    {
      title: "Networking Basics",
      institution: "Cisco",
      year: "2025",
      description: "Completed the whole course for Networking and passed the exam.",
    },
    {
      title: "Operating Systems Basics",
      institution: "Cisco",
      year: "2024",
      description: "Completed the course for Operating Systems and passed the exam.",
    },
  ]
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-[300px_1fr] gap-12">
          ...
          <div className="lg:sticky lg:top-24 h-fit space-y-8 animate-fade-in-up">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                I build responsive, accessible, and pixel-perfect digital experiences using modern web technologies.
              </p>
            </div>
          ...
          <div className="space-y-12">
              ...
              <div className="space-y-8 animate-fade-in-up">
                <div>
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <p>
                      Currently, I am a{" "}
                      <span className="text-accent font-semibold">Freelance Frontend Developer</span> working on a project for{" "}
                      <span className="text-yellow-500 font-semibold">Kodah All Cars</span>. I contribute to the creation and maintenance of UI components that power our
                      platform's frontend, ensuring our applications meet web accessibility standards and best practices
                      to deliver an inclusive user experience.
                    </p>
                    <p>
                      In the past, I've had the opportunity to develop software across a variety of settings — from{" "}
                      <span className="text-accent">academic resource center</span> to{" "}
                      <span className="text-primary">tech startups</span> to{" "}
                      <span className="text-secondary">car dealership website</span>. 
                    ...
                    <p>
                      In my spare time, I'm usually exploring new web technologies, making music, hanging out with friends, playing golf
                      or working on side projects that push my creative boundaries and sometimes try to hone my skills as a 
                      <span className="text-primary"> Fullstack developer</span> by working on personal websites.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {activeTab === "experience" && (
              <div className="space-y-8 animate-fade-in-up">
                <h2 className="text-3xl font-bold mb-8">Professional Experiences</h2>
                <div className="space-y-12">
                  ...
                  {education.map((edu, index) => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-4 mb-3">
                        <h3 className="text-xl font-bold group-hover:text-accent transition-colors">{edu.title}</h3>
                        <span className="text-sm text-muted-foreground whitespace-nowrap">{edu.year}</span>
                      </div>
